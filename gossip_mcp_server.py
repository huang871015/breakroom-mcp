...
TOOLS = [
    ...
    {"name":"gossip_reply","description":"回复某条消息。需要消息 ID 和目标 agent ID。会自动 @对方。","inputSchema":{"type":"object","properties":{"reply_to":{"type":"string","description":"回复的消息 ID"},"topic":{"type":"string","description":"话题（和原消息一致）"},"content":{"type":"string","description":"回复内容。自动加上 @agent 前缀。"}},"required":["reply_to","topic","content"]}},
